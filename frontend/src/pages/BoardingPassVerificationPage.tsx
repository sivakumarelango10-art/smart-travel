  ...
  if (!verification || !verification.valid) {
    return (
      <div className="max-w-md mx-auto py-20 px-4 text-center space-y-6 animate-fade-in">
        <div className="w-20 h-20 rounded-3xl bg-rose-500/15 text-rose-400 border border-rose-500/30 flex items-center justify-center mx-auto shadow-2xl">
        ...
        <Link
          to="/"
          className="inline-block px-6 py-3 rounded-2xl bg-[#14161F] hover:bg-[#181A22] text-slate-200 text-xs font-bold transition border border-white/10"
        >
          Return to Home
        </Link>
      </div>
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4 space-y-6 animate-fade-in">
      ...
      <div className="text-center space-y-4">
        <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-emerald-500/15 text-emerald-400 border-2 border-emerald-500/40 shadow-glow-emerald animate-pulse">
        ...
        <div className="inline-flex items-center gap-2 text-[11px] font-mono text-slate-400 bg-[#14161F] border border-white/10 px-4 py-1.5 rounded-xl">
          <Clock className="w-3.5 h-3.5 text-amber-400" />
          <span>Validated at: <strong className="text-white">{scanTimestamp}</strong></span>
        </div>
      </div>

      {/* 2. VERIFIED BOARDING PASS MANIFEST CARD */}
      <div className="rounded-3xl bg-[#14161F] border border-white/10 shadow-2xl overflow-hidden backdrop-blur-xl">
        {/* Header Strip */}
        <div className="p-6 bg-[#0B0C10] border-b border-white/10 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-xs text-slate-400 mt-0.5">
                <span className="font-mono text-amber-400 font-bold bg-[#181A22] px-2 py-0.5 rounded border border-white/10">
          ...
          <div className="text-right">
            <span className="text-[10px] uppercase font-mono font-bold text-slate-400 block">BOOKING REFERENCE</span>
            <span className="font-mono text-xl font-black text-amber-400">{verification.bookingReference}</span>
          </div>
        </div>

        {/* Route Timings & Airport Details */}
        <div className="p-6 sm:p-8 grid grid-cols-1 sm:grid-cols-3 gap-6 items-center text-center sm:text-left border-b border-white/10 bg-[#181A22]/50">
          <div>
            ...
            <p className="text-xs text-amber-400 font-mono font-bold mt-1">{depTimeFormatted}</p>
          </div>

          <div className="flex flex-col items-center justify-center">
            <div className="flex items-center gap-2 text-amber-400 font-bold">
              <span className="h-0.5 w-8 bg-amber-400/40 rounded" />
              <Plane className="w-5 h-5 transform rotate-90 text-amber-400" />
              <span className="h-0.5 w-8 bg-amber-400/40 rounded" />
            </div>
            <span className="text-[10px] font-mono font-black text-emerald-400 mt-2 uppercase tracking-widest bg-emerald-500/10 px-2.5 py-0.5 rounded-full border border-emerald-500/20 shadow-glow-emerald">
              NON-STOP • CONFIRMED
            </span>
        ...
        <div className="p-6 grid grid-cols-2 sm:grid-cols-4 gap-4 border-b border-white/10 text-xs">
          <div>
            <span className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Passenger Name</span>
            <p className="font-extrabold text-white mt-1 text-sm">{verification.passengerName}</p>
          </div>

          <div>
            <span className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Pass Number</span>
            <p className="font-mono font-bold text-slate-300 mt-1 text-xs truncate">
              {verification.boardingPassNumber}
            </p>
          </div>

          <div>
            <span className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Security Clearance</span>
          ...
          <div className="bg-amber-400/10 border border-amber-400/20 p-2.5 rounded-2xl text-center shadow-glow-gold">
            <span className="text-[10px] text-amber-400 uppercase font-black tracking-wider block">ALLOCATED SEAT</span>
            <p className="font-mono text-2xl font-black text-amber-400">{verification.seatNumber || '10F'}</p>
          </div>
        </div>

        {/* Gate & Terminal Callout */}
        <div className="p-6 bg-[#181A22]/70 grid grid-cols-2 sm:grid-cols-4 gap-4 border-b border-white/10 text-xs">
          <div>
            <span className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Boarding Gate</span>
          ...
          <div>
            <span className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Airport Terminal</span>
          ...
          <div>
            <span className="text-[10px] text-slate-400 uppercase font-bold tracking-wider">Flight Date</span>
        ...
        <div className="p-6 bg-[#0B0C10] flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link
              ...
              className="px-4 py-2.5 rounded-xl bg-gradient-to-r from-amber-400 to-amber-500 text-black text-xs font-extrabold flex items-center gap-1.5 shadow-glow-gold transition"
            >
            ...
            <Link
              to="/"
              className="px-4 py-2.5 rounded-xl bg-[#14161F] hover:bg-[#181A22] text-slate-200 text-xs font-bold border border-white/10 transition"
            >
              SmartTravel Home
            </Link>
          </div>
