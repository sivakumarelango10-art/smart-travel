...
const LIVE_EVENT_LOGS = [
  'GA-850 (DEL ➔ DPS) cruising over Indian Ocean towards Bali at FL390',
  '6E-1121 (BOM ➔ MLE) descending over Maldives archipelago into Malé',
  'AI-101 (DEL ➔ BOM) cruising at FL360 • Ground Speed 840 km/h',
  'AF-225 (DEL ➔ CDG) entered European Airspace • En route to Paris Charles de Gaulle',
  'JL-740 (DEL ➔ HND) crossing Pacific waypoint • ETA Tokyo on schedule',
  'BA-112 (LHR ➔ DEL) entered Indian Airspace • Descending to FL240',
  '6E-344 (DEL ➔ SXR) clear skies on approach to Srinagar Valley',
  'AI-409 (DEL ➔ COK) cruising over Western Ghats towards Kochi',
  'EK-500 (DXB ➔ BOM) approach clearance granted for Mumbai Runway 27',
  'AI-105 (DEL ➔ JFK) transatlantic routing active • Speed 890 km/h',
  'LX-155 (BOM ➔ ZRH) entering Swiss airspace over Alps',
