...
export const Footer: React.FC = () => {
  return (
    <footer className="border-t border-slate-800 bg-primary text-slate-400 text-xs">
      {/* 1. TRUST BAR */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <p className="text-xs text-slate-400 leading-relaxed pr-6">
            SmartTravel is a next-generation travel platform offering lightning-fast flight searches, interactive seat selection, luxury hotel bookings with 3D virtual previews, real-time live flight radar, and transparent auto-refunds.
          </p>
          <div className="flex flex-wrap items-center gap-2 pt-1">
            <span className="px-2.5 py-1 rounded-lg bg-slate-900 border border-slate-800 text-[10px] font-mono text-secondary">
              Spring Boot 3.3.x
            </span>
            <span className="px-2.5 py-1 rounded-lg bg-slate-900 border border-slate-800 text-[10px] font-mono text-white">
              React 18 + TS
            </span>
            <span className="px-2.5 py-1 rounded-lg bg-slate-900 border border-slate-800 text-[10px] font-mono text-emerald-400">
              MongoDB
            </span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <h4 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-1.5">
            <Plane className="w-3.5 h-3.5 text-secondary" /> Popular Flights
          </h4>
          <ul className="space-y-2 text-xs">
            <li>
              <Link to="/flights?origin=DEL&destination=BOM" className="hover:text-secondary transition">
                Delhi (DEL) → Mumbai (BOM)
              </Link>
            </li>
            <li>
              <Link to="/flights?origin=BLR&destination=DEL" className="hover:text-secondary transition">
                Bangalore (BLR) → Delhi (DEL)
              </Link>
            </li>
            <li>
              <Link to="/flights?origin=BOM&destination=GOI" className="hover:text-secondary transition">
                Mumbai (BOM) → Goa (GOI)
              </Link>
            </li>
            <li>
              <Link to="/flights?origin=BOM&destination=DXB" className="hover:text-secondary transition">
                Mumbai (BOM) → Dubai (DXB)
              </Link>
            </li>
            <li>
              <Link to="/flights?origin=DEL&destination=LHR" className="hover:text-secondary transition">
        ...
        <div className="space-y-3">
          <h4 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-1.5">
            <Building2 className="w-3.5 h-3.5 text-secondary" /> Hotels & Features
          </h4>
          <ul className="space-y-2 text-xs">
            <li>
            ...
            <li>
              <Link to="/live-tracker" className="hover:text-secondary transition">
                Live Flight Radar
              </Link>
            </li>
            <li>
              <Link to="/offers" className="hover:text-secondary transition">
                Price Freeze & Deals
              </Link>
            </li>
            <li>
        ...
        <div className="space-y-3">
          <h4 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-1.5">
            <Compass className="w-3.5 h-3.5 text-secondary" /> Developer & Info
          </h4>
          <ul className="space-y-2 text-xs">
            <li>
              <Link to="/account" className="hover:text-secondary transition">
            ...
            <li>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="hover:text-secondary transition flex items-center gap-1 font-mono text-secondary"
              >
